...
export const seedProjects: Project[] = [
  {
    ...
    endDate: '2026-08-30',
    teamMemberIds: ['user_super', 'user_pm', 'user_foreman', 'user_sub', 'user_owner'],
  ...
  },
  {
    ...
    endDate: '2026-05-15',
    teamMemberIds: ['user_pm', 'user_sub', 'user_owner'],
